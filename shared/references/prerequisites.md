...
- **Resume missing** → "Run `/wingman:setup` first so I have your CV."
- **Preferences missing** → "Run `/wingman:setup` first to set target roles and dealbreakers."
...
- **Contacts missing** → "No contacts imported. Run `/wingman:setup` and export your LinkedIn or Xing connections first."
